...
if [[ ${UNAME} == *"MINGW64"* ]]; then
  ...
  cp -v "${MSYSTEM_PREFIX}/bin/libicuin77.dll" "${install_dir}"
  cp -v "${MSYSTEM_PREFIX}/bin/libicuuc77.dll" "${install_dir}"
  cp -v "${MSYSTEM_PREFIX}/bin/libicudt77.dll" "${install_dir}"
